...
def main() -> None:
    ...
    lines = [
        ...
        f"| DAST: OWASP ZAP | `reports/dast/summary.md` | {first_matching(dast, '- Total alerts:')} alerts, gate blocks Medium/High |",
        "",
        "## Included Reports",
        "",
        ...
        "## Notes",
        "",
        "The CI/CD security gate fails on SAST, SCA and secrets findings. For DAST it fails on Medium and High risk alerts; informational and low-risk observations remain in the artifact for manual review.",
        "",
    ]
